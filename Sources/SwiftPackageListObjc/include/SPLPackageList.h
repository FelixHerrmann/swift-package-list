...
/// This function reads the package-list file in the specified bundle with the specified file name.
///
/// Make sure that the file is part of your project/target.
/// @param bundle The bundle where the file is stored.
/// @param fileName The name of the package-list file.
...
NSArray<SPLPackage *> *_Nullable SPLPackageListFromBundleWithFileName(NSBundle *bundle, NSString *fileName, NSError **errorPtr);
